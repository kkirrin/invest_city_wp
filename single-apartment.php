        ...
        <div class="container">
            <nav class="single-block">
                <ul>
                    ...
                    <li>
                        <button class="tab_btn active">Планировка</button>
                    </li>
                    <li>
                        <button class="tab_btn">План этажа</button>
                    </li>
                </ul>
            </nav>
    ...
    <section>
        <div class="container">
            ...
            <?php
                        ...
                        echo '<div id="content-1" class="tab-content active">';
                        ...
                        echo '              <button class="button_main button_main--bron">Забронировать</button> ';
                    ...
                    echo '<div id="content-2" class="tab-content"> ';
                    echo '  <div class="flex md:flex-row flex-col justify-between items-start gap-[40px]"> ';
                    echo '  </div> ';
                    echo '</div> ';
                ?>
